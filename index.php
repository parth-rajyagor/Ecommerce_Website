    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-info">
            <div class="container-fluid">
                <a href="index.php"><img src="./images/logo.jpg" alt="" class="logo"></a>
            ...
            <div class="col-md-10">
                <div class="row">
                    <?php
                        ...
                        getproducts($products_per_page, $offset);  // calling function
                        
                        get_unique_categories();    // fetching unique categories
                        get_unique_brands();        // fetching unique brands
                        cart();
                    ?>
                </div>
            </div>
